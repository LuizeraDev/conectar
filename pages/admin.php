    ...
    <ul id="slide-out" class="sidenav">
      <li>
        <div class="user-view">
          ...
          <a href="#email"><span class="white-text email">conecta@gmail.com</span></a>
        </div>
      </li>
      <li>
        <a href="#"><i style="color:#005748;" class="cor fab fa-2x fas fa-cookie-bite"></i>Aprovar Pedido(s)</a>
        <a href="#"><i style="color:#005748;" class="cor fab fa-2x fas fa-cog"></i>Bugs Reportados</a>
      </li>
      <li>
